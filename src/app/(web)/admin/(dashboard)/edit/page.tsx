              ...
              <tr key={post.id} className="border-b border-border/40 last:border-none group/row hover:bg-white/[0.01] transition-all">
                <td className="py-4 px-2">
                  <div className="flex items-center gap-2">
                    <Link href={`/admin/post?post=${post.id}&action=edit`} className="text-text font-semibold hover:text-primary transition-colors text-sm no-underline leading-snug">
                  ...
                  <div className="flex items-center gap-2 mt-1.5 text-xs opacity-0 group-hover/row:opacity-100 transition-opacity duration-200">
                    {post.postStatus === 'trash' ? (
                      ...
                      <div className="flex items-center gap-2.5">
                        <Link href={`/admin/post?post=${post.id}&action=edit`} className="text-primary hover:text-primary-light no-underline font-medium transition-colors">
                          Editar
                        </Link>
                        <span className="text-border/50">|</span>
